...
scienceInputFolder = os.path.join(*[WorkPath, 'CCFs', cfgFile.get('global', 'data')])

sys.path.append(WorkPath)

resultsFolder = os.path.join(*[WorkPath, 'results', cfgFile.get('global', 'data')])
...
starWidth = float(cfgFile.get('recovery', 'starWidth'))
# endregion
